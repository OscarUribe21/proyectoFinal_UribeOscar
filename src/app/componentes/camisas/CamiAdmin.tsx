...
export const CamiAdmin = () => {
  ...
  const eliminarCamisa = (codigo: number) => {
    setArrCamisas(arrCamisas.filter((cami) => cami.codCamisas !== codigo));
  };
          ...
          <table className="table table-striped table-hover">
            ...
            <tbody>
              {arrCamisas.map((miCami: Camisas) => (
                <tr className="align-middle" key={miCami.codCamisas}>
                  <td>{miCami.codCamisas}</td>
                  <td>{miCami.marcaCamisas}</td>
                  <td>{miCami.colorCamisas}</td>
                  <td>{obtenerNombreTalla(miCami.codTallaCamisas)}</td>
                  <td>
                    <img
                  ...
                  <td className="text-center">
                    ...
                    <NavLink to={"/cactual/" + miCami.codCamisas}>
          ...
          >
            ...
            <ModalFooter>
              ...
              <Button
                variant="danger"
                onClick={() => {
                  eliminarCamisa(objCami.codCamisas);
                  setShow(false);
                }}
              >
                Eliminar
